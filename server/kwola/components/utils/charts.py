...
def generateAllCharts(config, applicationId=None, enableCumulativeCoverage=False):
    ...
    futures.append(pool.apply_async(generateLossChart, [config.serialize(), applicationId, 'discountedFutureRewardLosses', "Discounted Future Reward Loss", 'neural_network_discounted_future_reward_loss_chart.png']))
