...
class DeepLearningAgent:
    ...
    def createDebugVideoForExecutionSession(self, executionSession, includeNeuralNetworkCharts=True, includeNetPresentRewardChart=True, hilightStepNumber=None, cutoffStepNumber=None):
        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=1) as executor:
            ...
            for trace, rawImage, networkOutput in zip(executionTracesFiltered, rawImages, networkOutputs):
    ...
    def createDebugImagesForExecutionTrace(self, executionSessionId, debugImageIndex, trace, rawImage, lastRawImage, networkOutput, presentRewards, discountedFutureRewards, tempScreenshotDirectory, includeNeuralNetworkCharts=True, includeNetPresentRewardChart=True, hilight=0, rewardBounds=None, uniqueActionColors=None):
        """
